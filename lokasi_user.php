			...
			<div class="navbar-inner">
				<div class="container">
					<ul class="nav nav-tabs nav-justified">
						...
						<li role="presentation" class="active"><a href="index_user.php">Home</a></li>
						<li role="presentation"><a href="informasi_user.php">Informasi</a></li>
						<li role="presentation" class="active"><a href="lokasi_user.php">Lokasi</a></li>
				...
				<div class="panel panel-success">
					<div class="panel-body">
						...
						<div class="text_area" align="justify">
							<br />
							<div class="title">Lokasi Fasilitas Kejiwaan</div>
							<br />
							...
							<table table class="table table-bordered" border="0" align="center" cellpadding="5" cellspacing="0" bordercolor="#666666" id="pag">
								...
								?>
									...
									<tr class="<?php if ($no % 2 == 1) echo "isitabelganjil";
										...
										<td align="center"><a href="detaillokasi_display_user.php?page=4&act=detaillokasi&kd_peta=<?php echo $data['kd_peta']; ?>"><img src="gambar/detail.png" align="middle" width="20" border="0"> Detail</a>
