					...
					<div class="panel-body">
						...
						?>
							...
							<div class="text_area" align="justify">
								...
								<br>
								<form action="aceditgejala.php?page=5&act=aceditgejala" method="post">
									<table>
										<tr>
											<td colspan="3">
												<hr color="#AAAAAA">
										...
										<tr>
											...
											<td><span id="sprytextfield22"><input name="nama_gejala" type="text" value="<?php echo $data['nama_gejala']; ?>" size="30" />
													<br />
													<span class="textfieldRequiredMsg"><img src="gambar/hapus.png" width="10" height="10"> Nama gejala harus diisi</span></span></td>
										</tr>
										<tr>
											<td colspan="3">
												<hr color="#AAAAAA">
