			...
			<div class="navbar-inner">
				<div class="container">
					<ul class="nav nav-tabs nav-justified">
						...
						<li role="presentation" class="active"><a href="Artikel_display.php">Artikel</a></li>
							...
							<table table class="table table-bordered" border="0" align="center" cellpadding="5" cellspacing="0" bordercolor="#666666" id="pag">
								...
								?>
									...
									<tr class="<?php if ($no % 2 == 1) echo "isitabelganjil";
										...
										<td align="center"><a href="detailartikel_display.php?page=4&act=detailartikel&kd_artikel=<?php echo $data['kd_artikel']; ?>"><img src="gambar/detail.png" align="middle" width="20" border="0"> Lanjutkan Membaca</a>
										</td>
									</tr>
								<?php } ?>
