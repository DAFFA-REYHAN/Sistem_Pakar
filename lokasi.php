			...
			<div class="navbar-inner">
				<div class="container">
					<ul class="nav nav-tabs nav-justified">
						...
						<li role="presentation" class="active"><a href="lokasi.php">Lokasi</a></li>
				...
				<div class="panel panel-success">
					<div class="panel-body">
						...
						<div class="text_area" align="justify">
							<br />
							<div class="title">Pengolahan Data Lokasi</div>
							<br />


							<?php $jmldata = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM peta"));
							echo "<center style=text-decoration:blink>Terdapat <b>$jmldata</b> record peta</center>"; ?>
							<br>
							<table table class="table table-bordered" border="0" align="center" cellpadding="5" cellspacing="0" bordercolor="#666666" id="pag">
								<tr tr bgcolor="gray" align="center">
									<td><b>
											<font color="white" size=3>Kode lokasi</font>
										</b></td>
									<td><b>
											<font color="white" size=3>Nama Rumah Sakit</font>
										</b></td>
									<td><b>
											<font color="white" size=3>Kota</font>
										</b></td>
									<td><b>
								...
								$no = 0;
								$qlog = mysqli_query($conn, "SELECT * FROM peta ORDER BY kd_peta ASC LIMIT $posisi,$batas");
								...
								?>
									...
									<tr class="<?php if ($no % 2 == 1) echo "isitabelganjil";
										...
										<td align="center" name="username"><?php echo $data['kd_peta']; ?></td>
										<td><?php echo $data['nama_rs']; ?></td>
										<td><?php echo $data['kota']; ?></td>
										<td align="center"><a href="detaillokasi.php?page=4&act=detaillokasi&kd_peta=<?php echo $data['kd_peta']; ?>"><img src="gambar/detail.png" align="middle" width="20" border="0"> Detail</a>
											|<a href="editlokasi.php?page=4&act=editlokasi&kd_peta=<?php echo $data['kd_peta']; ?>"><img src="gambar/edit.png" width="20" align="middle" border="0"> Ubah</a>
									</tr>
								<?php } ?>
								<tr tr bgcolor="gray">
									<td colspan="4" align="center"><a class="link" href="tambahlokasi.php"><img src="gambar/add.png" width="20" border="0"> Tambah</a></td>
								</tr>
							</table>
							<?php
