<div class="text_area" align="justify">
	...
	<?php 
		...
		echo "<center style=text-decoration:blink>Terdapat <b>$jmldata</b> Data Gejala</center>"; 
	?>
						...
						<form action="actambahgejala.php" method="post">
							<table class="w-100">
								<tr>
									...
									<td>:</td>
									<td>
										<input name="kode_gejala" type="text" size="5" maxlength="5" disabled value="<?php echo kdautogejala("gejala", "G"); ?>" />
								...
								<tr>
									...
									<td>:</td>
									<td>
										<textarea name="nama_gejala" cols="30" rows="3" require></textarea>
										<br />
									</td>
								</tr>
								<tr>
									<td colspan="3" align="center" onclick="return confirm('Apakah Anda Yakin Menyimpan Data Gejala Ini ?')">
			...
			?>
				<tr class="<?php 
					...
					<td align="center">
												...
												<form action="aceditgejala.php" method="post">
													<table>
														<tr>
															...
															<td>
																<input name="tkode" type="text" size="5" maxlength="5" disabled value="<?php echo $kode_gejala; ?>" />
														...
														<tr>
															...
															<td class="subtitle">:</td>
															<td>
																<textarea name="nama_gejala" cols="30" rows="3" require><?php echo $editP['nama_gejala']; ?></textarea>
															</td>
														</tr>
														<tr>
															<td colspan="3" align="center">
																<input type="submit" name="simpan" value="Simpan" onclick="return confirm('Apakah Anda Yakin Mengubah Data Gejala Ini ?')" />
															</td>
														</tr>
													</table>
												</form>
						...
						<a href="hapusgejala.php?kode_gejala=<?php echo $data['kode_gejala']; ?>" onclick="return confirm('Apakah Anda Yakin Menghapus Data Gejala Ini ?')" class="btn btn-danger btn-sm mt-2"><img src="gambar/hapus.png" width="20" align="middle" border="0"> Hapus</a>
					</td>
				</tr>
			<?php 
				} 
