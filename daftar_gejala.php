			...
			?>
				<tr class="<?php if ($no % 2 == 1) echo "isitabelganjil";
					...
					<td align="center">
						...
						<a href="hapusgejala.php?kode_gejala=<?php echo $data['kode_gejala']; ?>" onclick="return confirm('Apakah anda yakin data gejala ini akan dihapus?')" class="btn btn-danger btn-sm mt-2"><img src="gambar/hapus.png" width="20" align="middle" border="0"> Hapus</a>
					</td>
				</tr>
			<?php } ?>
		</tbody>
