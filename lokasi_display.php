			...
			<div class="navbar-inner">
				<div class="container">
					<ul class="nav nav-tabs nav-justified">
						...
						<li role="presentation" class="active"><a href="lokasi_display.php">Lokasi</a></li>
							...
							<table table class="table table-bordered" border="0" align="center" cellpadding="5" cellspacing="0" bordercolor="#666666" id="pag">
								...
								?>
									...
									<tr class="<?php if ($no % 2 == 1) echo "isitabelganjil";
										...
										<td align="center"><a href="detaillokasi_display.php?page=4&act=detaillokasi&kd_peta=<?php echo $data['kd_peta']; ?>"><img src="gambar/detail.png" align="middle" width="20" border="0"> Detail</a>
