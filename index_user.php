		...
		<div class="row">
			...
			<div class="panel panel-success">
			  <div class="panel-body">
					...
					<br /><div class="title">Selamat Datang <?php echo $username;?></div>
					<br />

					Anda dapat melakukan <b>DIAGNOSA</b> dan <b>MELIHAT HASIL DIAGNOSA</b> sebelumnya, sesuai dengan menu pilihan.<br />
