		...
		<form action="login.php" method="post">
			<p>NAMA PENGGUNA
				<span id="sprytextfield1">
					...
					<br>
					<span class="textfieldRequiredMsg"><img src="gambar/hapus.png" width="10" height="10"> Nama Pengguna Harus Diisi</span></span>
				<br />
				KATA KUNCI
				<span id="sprytextfield2">
					<input name="password" type="password" id="password" size="20" maxlength="10" />
					<br>
					<span class="textfieldRequiredMsg"><img src="gambar/hapus.png" width="10" height="10"> Kata Kunci Harus Diisi</span></span><br />
