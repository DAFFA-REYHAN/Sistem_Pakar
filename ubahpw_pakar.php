            ...
            <?php
              ...
              if (isset($_POST['tombol'])) {
                if ($_POST['g-recaptcha-response'] != "") {
                  ...
                  if ($cek > 0) {
                    $qry = mysqli_query($conn, "UPDATE data_pakar SET password='" . md5($_POST['passwordbaru']) . "',  
	   pertanyaan='$pertanyaan', jawaban='" . md5($_POST['jawaban']) . "' WHERE username='$username'");

                    echo "<meta http-equiv=\"refresh\" content=\"0; url=index_pakar.php?page=7&current0=curren&act=berhasil&u=$username\">";
                  } else {
                    echo  "<meta http-equiv=\"refresh\" content=\"0; url=index_pakar.php?page=7&current0=curren&act=gagal&u=$username\">";
                  }
                } else {
                  echo "<meta http-equiv=\"refresh\" content=\"0; url=index_pakar.php?page=7&current0=curren&act=gagal2&u=$username\">";
                }
              }
            } elseif ($act == "berhasil") {
            ?>
              ...
              <div class="text_area" align="justify">
                <center><img src="images/493.jpg" title="thanks" />
                  <br />
                  ...
                  <table>
                    ...
                    <tr>
                      ...
                      <td valign="bottom"><span id="sprypassword9">
                        ...
                        <br>
                        <span class="style3">
                          <font color="red"><strong>Kata Kunci</strong></font>
                        </span><span class="style2">
                          <font color="red"><strong> Lama Salah</strong></font>
                        </span>
                      </td>
                    ...
                    <tr>
                      ...
                      <td><span id="spryconfirm">
                          <input name="passwordbaru2" type="password" size="15" maxlength="30" />
                          <span class="confirmRequiredMsg"><img src="gambar/hapus.png" width="10" height="10"> Konfirmasi Kata Kunci Harus Diisi.</span>
                          <span class="confirmInvalidMsg"><img src="gambar/hapus.png" width="10" height="10"> <span class="confirmRequiredMsg">Kata Kunci </span> Harus Cocok.</span></span></td>
                    </tr>
                    ...
                    <tr>
                      <td colspan="3">
                        <div class="subtitle">Jika Anda Lupa <span class="confirmRequiredMsg">Kata Kunci </span></div>
                      </td>
                    </tr>
                    <tr>
                      <td>Pilih Pertanyaan Rahasia</td>
            ...
            ?>
              ...
              <div class="text_area" align="justify">
                ...
                <link href="SpryAssets/SpryValidationConfirm.css" rel="stylesheet" type="text/css" />
                <div class="title">
                  <font color="red">Ubah <span class="confirmRequiredMsg">Kata Kunci </span> Gagal Disimpan</font>
                </div>
                <br>
                <form action="?page=7&act=acubahpass&u=<?php echo $username; ?>" method="post" align="left" cellpadding="5">
                  <table>
                    ...
                    <tr>
                      <td valign="top"><span class="confirmRequiredMsg">Kata Kunci </span> Lama</td>
                      <td valign="top">:</td>
                      <td valign="bottom"><span id="sprypassword9">
                          <input name="passwordlama" type="password" id="passwordlama" size="15" maxlength="30" />
                    ...
                    <tr>
                      <td valign="top"><span class="confirmRequiredMsg">Kata Kunci </span> Baru</td>
                      <td valign="top">:</td>
                      <td valign="bottom"><span id="sprypassword99">
                          <input name="passwordbaru" type="password" id="passwordbaru" size="15" maxlength="30" />
                          <span class="passwordRequiredMsg"><img src="gambar/hapus.png" width="10" height="10"> Password Harus Diisi.</span>
                    ...
                    <tr>
                      <td>Konfirmasi <span class="confirmRequiredMsg">Kata Kunci </span> Baru</td>
                      <td>:</td>
                      <td><span id="spryconfirm">
                          <input name="passwordbaru2" type="password" size="15" maxlength="30" />
                          <span class="confirmRequiredMsg"><img src="gambar/hapus.png" width="10" height="10"> Konfirmasi Kata Kunci Harus Diisi.</span>
