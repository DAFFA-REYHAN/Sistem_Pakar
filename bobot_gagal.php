					...
					<div class="panel-body">
						...
						?>
							...
							<div class="text_area" align="justify">
								...
								<br />
								<div class="title">Bobot Gejala Gagal Disimpan, Priksa Kembali Apakah Total Nilai
									Bobot Sudah 100%</div>
									...
									<table width="100%" align="center" cellpadding="5">
											...
											<td>
												<select name="jumpMenu" id="jumpMenu" onChange="MM_jumpMenu('parent',this,0)">
													...
													while ($datap = mysqli_fetch_array($qryp)) {
														...
														echo "<option value='bobot_gagal.php?page=8&act=gagal&kode_penyakit=$datap[kode_penyakit]' $cek>$datap[nama_penyakit]</option>";
													}
													?>
												</select>
										...
										?>
											<tr>
												...
												<td><span id="sprytextfield<?php echo $a; ?>">
														...
														<span class="textfieldRequiredMsg"><img src="gambar/hapus.png" width="10" height="10"> Bobot harus diisi.</span>
														<span class="textfieldInvalidFormatMsg"><img src="gambar/hapus.png" width="10" height="10"> Nilai harus berupa angka.</span>
														<span class="textfieldMaxCharsMsg"><img src="gambar/hapus.png" width="10" height="10"> Maksimal 3 angka.</span>
														<span class="textfieldMinValueMsg"><img src="gambar/hapus.png" width="10" height="10"> Minimal 1 persen.</span>
														<span class="textfieldMaxValueMsg"><img src="gambar/hapus.png" width="10" height="10"> Maksimal 100 persen.</span>
													</span></td>
											</tr>
										<?php } ?>
										<tr>
										...
										<tr>
											<td colspan="3" class="subtitle">
												<font color="red">Total Jumlah Bobot Harus 100%</font>
											</td>
