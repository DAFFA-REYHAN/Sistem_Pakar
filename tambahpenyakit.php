								...
								<form action="?page=4&act=actambahpenyakit" method="post">
									<table>
										...
										<tr>
											<td>Nama Penyakit</td>
											<td>:</td>
											<td><span id="sprytextarea1"><textarea name="nama_penyakit" cols="30" rows="3"></textarea><br />
													<span class="textareaRequiredMsg"><img src="gambar/hapus.png" width="10" height="10"> Nama penyakit masih kosong.</span></span></td>
										</tr>
										<tr>
											<td>Definisi</td>
											<td>:</td>
											<td><span id="sprytextarea2"><textarea name="definisi" cols="80" rows="5"></textarea><br />
													<span class="textareaRequiredMsg"><img src="gambar/hapus.png" width="10" height="10"> Definisi penyakit masih kosong.</span></span></td>
										</tr>
										<tr>
											<td>Pengobatan</td>
											<td>:</td>
											<td><span id="sprytextarea3"><textarea name="pengobatan" cols="80" rows="5"></textarea><br />
													<span class="textareaRequiredMsg"><img src="gambar/hapus.png" width="10" height="10"> Pengobatan masih kosong.</span></span></td>
										</tr>
										<tr>
											<td>Pencegahan</td>
											<td>:</td>
											<td><span id="sprytextarea4"><textarea name="pencegahan" cols="80" rows="5"></textarea><br />
													<span class="textareaRequiredMsg"><img src="gambar/hapus.png" width="10" height="10"> Pencegahan masih kosong.</span></span></td>
										</tr>
										<tr>
