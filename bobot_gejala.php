...
<!-- <div class="text_area" align="justify">
	...
	<form method="post" action="simpan_bobot.php">
		<table width="100%" align="center" cellpadding="5">
			...
			<tr>
				<td align="center" class="judul"><input class="btn btn-primary btn-lg active" type="submit" name="simpan" value="Simpan" onclick="return confirm('Apakah Anda Yakin Menyimpan Data Bobot Gejala Ini ?')" />&nbsp;<input class="btn btn-primary btn-lg active" type="reset" value="Normalkan" /></td>
			</tr>
		</table>
	</form>
</div> -->
...
<div class="text_area" align="justify">
	...
	<form method="post" action="simpan_bobot.php">
		<table width="100%" align="center" cellpadding="5">
			...
			<?php
				$qry = mysqli_query($conn, "SELECT * FROM relasi_penyakit_gejala INNER JOIN gejala ON gejala.kode_gejala = relasi_penyakit_gejala.kode_gejala WHERE relasi_penyakit_gejala.kode_penyakit = '$kode_penyakit' ORDER BY gejala.kode_gejala ASC");
				$a = 0;
				while ($data = mysqli_fetch_array($qry)) {
					++$a;
			?>
			...
			<tr>
				<td align="center" class="judul"><input class="btn btn-primary btn-lg active" type="submit" name="simpan" value="Simpan" onclick="return confirm('Apakah Anda Yakin Menyimpan Data Bobot Gejala Ini ?')" /></td>
			</tr>
		</table>
	</form>
</div>