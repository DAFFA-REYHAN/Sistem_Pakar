			...
			<div class="navbar-inner">
				<div class="container">
					...
					<li role="presentation">
						...
						<li role="presentation" class="active"><a href="contact_user.php">Contact Us</a></li>
					</ul>
				</div>
			</div>
		</nav>
		...
		<div class="row">
			...
			<div class="panel panel-success">
			  <div class="panel-body">
							...
							<table>
<tr>
<td><img src="gambar/about.jpg" width="255" height="305" align="middle"/></td>
</tr>
<tr>
<td ><h2>Jesreel Surbakti.</h2></td>
</tr>
<tr>
<td><h3>Npm :13111816 </h3></td>
</tr>
<tr>
<td><h3>Website ini dibuat dengan harapan dapat 
menambah pengetahuan masyarakat tentang penyakit kejiwaan.</h2></td>
</tr>
<tr>
<td><h3>Jika ada tulisan,gambar, atau icon milik anda yang 
dicantumkan diwebsite ini dengan tidak mencantumkan refrensi.
Silahkan kirimkan email anda melalui halaman Contac Us, 
agar tulisan,gambar, atau icon anda dapat dicantumkan refrensinya. 
Mohon maaf atas ketidaksengajaannya. Terimakasih.</h2></td>
</tr>
</table>
