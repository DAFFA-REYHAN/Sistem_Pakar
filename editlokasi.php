					...
					<div class="panel-body">
						...
						<div class="text_area" align="justify">
							...
							?>
								<br>
								<div class="text_area" align="justify">
									<div class="title">Ubah Data Lokasi</div>
									<br>
									<form action="aceditlokasi.php?page=4&act=aceditpenyakit" method="post">
										<table>
											<tr>
												<td colspan="3">
													<hr color="#AAAAAA">
											...
											<tr>
												...
												<td><input name="tkode" type="text" size="5" maxlength="5" disabled value="<?php echo $kd_peta; ?>" />
													<input name="kd_peta" type="hidden" value="<?php echo $kd_peta; ?>" />
												</td>
											</tr>
											<tr>
												<td class="subtitle">Nama Rumah Sakit</td>
												<td class="subtitle">:</td>
												<td><span id="sprytextfield22"><input name="nama_rs" type="text" value="<?php echo $data['nama_rs']; ?>" size="30" />
														<br />
														<span class="textfieldRequiredMsg"><img src="gambar/hapus.png" width="10" height="10"> Nama Lokasi</span></span></td>
											</tr>
											<tr>
												<td class="subtitle">Kota</td>
												<td class="subtitle" align="center">:</td>
												<td><span id="sprytextarea2"><textarea name="kota" cols="30" rows="3"><?php echo $data['kota']; ?></textarea>
														<br><span class="textareaRequiredMsg"><img src="gambar/hapus.png" width="10" height="10"> Kota harus diisi</span></span></td>
												</td>
											</tr>
											<tr>
												<td class="subtitle">link</td>
												<td class="subtitle" align="center">:</td>
												<td><span id="sprytextarea3"><textarea name="link" cols="30" rows="3"><?php echo $data['link']; ?></textarea>
														<br><span class="textareaRequiredMsg"><img src="gambar/hapus.png" width="10" height="10"> link masih kosong.</span></span></td>
												</td>
											</tr>
											<tr>
												<td colspan="3">
