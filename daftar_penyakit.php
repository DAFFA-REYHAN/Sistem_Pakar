						...
						<form action="actambahpenyakit.php" method="post">
							<table>
								...
								<tr>
									<td>Nama Penyakit</td>
									<td>:</td>
									<td><textarea name="nama_penyakit" cols="30" rows="3" require></textarea><br />
									</td>
								</tr>
								<tr>
									<td>Definisi</td>
									<td>:</td>
									<td><textarea name="definisi" cols="80" rows="5" require></textarea><br />
									</td>
								</tr>
								<tr>
									<td>Pengobatan</td>
									<td>:</td>
									<td><textarea name="pengobatan" cols="80" rows="5" require></textarea><br /></td>
								</tr>
								<tr>
									<td>Pencegahan</td>
									<td>:</td>
									<td><textarea name="pencegahan" cols="80" rows="5" require></textarea><br />
									</td>
								</tr>
								<tr>
									<td colspan="3" align="center" onclick="return confirm('Penyakit yang akan di simpan sudah sesuai ?')"><input type="submit" name="simpan" value="Simpan" />
			...
			?>
				...
				<tr class="<?php if ($no % 2 == 1) echo "isitabelganjil";
					...
					<td align="center">
												...
												<form action="aceditpenyakit.php" method="post">
													<table>
														...
														<tr>
															<td class="subtitle">Nama Penyakit</td>
															<td class="subtitle">:</td>
															<td><input name="nama_penyakit" type="text" value="<?php echo $editP['nama_penyakit']; ?>" size="30" require>
														</tr>
														<tr>
															<td class="subtitle">Definisi</td>
															<td class="subtitle" align="center">:</td>
															<td><textarea name="definisi" cols="80" rows="5" require><?php echo $editP['definisi']; ?></textarea>
															</td>
														</tr>
														<tr>
															<td class="subtitle">Pengobatan</td>
															<td class="subtitle" align="center">:</td>
															<td><textarea name="pengobatan" cols="80" rows="5" require><?php echo $editP['pengobatan']; ?></textarea>
															</td>
														</tr>
														<tr>
															<td class="subtitle">Pencegahan</td>
															<td class="subtitle" align="center">:</td>
															<td><textarea name="pencegahan" cols="80" rows="5" require><?php echo $editP['pencegahan']; ?></textarea>
															</td>
														</tr>
														<tr>
															<td colspan="3">
						...
						<a href="hapuspenyakit.php?kode_penyakit=<?php echo $data['kode_penyakit']; ?>" onclick="return confirm('Apakah anda yakin data penyakit ini akan dihapus?')" class="btn btn-danger btn-sm mt-2"><img src="gambar/hapus.png" width="20" align="middle" border="0"> Hapus</a>
					</td>
				</tr>
			<?php } ?>
		</tbody>
