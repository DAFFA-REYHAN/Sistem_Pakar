					...
					<div class="panel-body">
						...
						?>
							<div class="text_area" align="justify">
								...
								<br />
								<form action="?page=4&act=actambahartikel" method="post" enctype="multipart/form-data">
									<table>
										<tr>
											<td>Kode artikel</td>
											<td>:</td>
										...
										<tr>
											<td>Judul Artiel</td>
											<td>:</td>
											<td><span id="sprytextarea1"><textarea name="judul" cols="30" rows="3"></textarea><br />
													<span class="textareaRequiredMsg"><img src="gambar/hapus.png" width="10" height="10"> Judul artikel masih kosong.</span></span></td>
										</tr>
										<tr>
											<td>Penulis</td>
											<td>:</td>
											<td><span id="sprytextarea2"><textarea name="penulis" cols="30" rows="3"></textarea><br />
													<span class="textareaRequiredMsg"><img src="gambar/hapus.png" width="10" height="10"> Penulis artikel masih kosong.</span></span></td>
										</tr>
										<tr>
											<td>Abstrak</td>
											<td>:</td>
											<td><span id="sprytextarea3"><textarea name="abstrak" cols="80" rows="5"></textarea><br />
													<span class="textareaRequiredMsg"><img src="gambar/hapus.png" width="10" height="10"> Abstrak masih kosong.</span></span></td>
										</tr>
										<tr>
											<td>Isi</td>
											<td>:</td>
											<td><span id="sprytextarea4"><textarea name="isi" cols="80" rows="15"></textarea><br />
													<span class="textareaRequiredMsg"><img src="gambar/hapus.png" width="10" height="10"> Isi artikel kosong.</span></span></td>
										</tr>
										<tr>
											<td>Gambar</td>
											<td>:</td>
						...
						<?php
							...
							$id = $jumlah + 1;
							mysqli_query($conn, "INSERT INTO artikel  (kd_artikel, judul, penulis, abstrak, isi, gambar) VALUES  ('$kd_artikel','$judul','$penulis','$abstrak','$isi','$fileName')");
							echo "<meta http-equiv=\"refresh\" content=\"0; url=artikel.php\">";

							move_uploaded_file($_FILES['gambar']['tmp_name'], "gambarartikel/" . $_FILES['gambar']['name']);
						}
						?>
