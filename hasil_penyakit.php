            ...
            <tr>
              ...
              <?php
                $qry_penyakit = mysqli_query($conn, "SELECT * FROM penyakit WHERE kode_penyakit = '$data[kode_penyakit]'") or die(mysqli_error());
                $data_penyakit = mysqli_fetch_array($qry_penyakit);
              ?>
              <tr>
                <td valign="top">Penyakit</td>
              ...
              <tr>
                ...
                <td>
                    <?php 
                      echo number_format($data['persentase'], 2, '.', '') . ' %' . ' Gejala Terpenuhi'; 
                    ?>
                </td>
              </tr>
              <tr>
